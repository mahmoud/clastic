...
from clastic import Application, tbutils
from clastic.render.ashes_templates import AshesRenderFactory

# TODO: look into __traceback_hide__
# TODO: detect and report when data is POSTed but not form encoded
...
def test_500(request):
    try:
        ...
        exc_info = tbutils.ContextualExceptionInfo.from_current()
...
def main():
    ...
    arf.register_source('500.html', HTML_500_TMPL)
    routes = [('/', test_500, '500.html')]
    return Application(routes, render_factory=arf).serve()


# note: django has a frame "type" which is 'django'
# if in a django frame, and 'user if not'
