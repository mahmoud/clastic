...
"""werkzeug.serving
    ...
    (from werzeug==0.9.4. clastic/server.py got pretty intertwined with this
    module and then it changed. maybe not so bad, but it's vendored to
    avoid the rest of clastic falling too far behind werkzeug updates.
