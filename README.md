...
[![PyPI](https://img.shields.io/pypi/v/clastic.svg)](https://pypi.org/project/clastic/)
[![CalVer](https://img.shields.io/badge/calver-YY.MINOR.MICRO-22bfda.svg)](https://calver.org/)
...
While originally built to host [a simple train schedule site](https://github.com/mahmoud/etavta)
and [a few Wikipedia-related projects](https://github.com/hatnote), Clastic is also used
...
> **Note:** The following is a conceptual introduction, not class
...
: Middleware is a way of splitting up and ordering logic in
  ...
  [Middleware](#middleware) section for more information, including diagrams of
...
> **Note:** For the record, the `Application` instantiation seen above is exactly
...
- **Route URL pattern**
- **Application resources** - As [mentioned above](#resources), arguments which
  are valid for the lifespan of the Application.
- **Middleware provides** - Arguments provided by an Application's
  middleware. See [Middleware](#middleware) for more information.
- **Clastic built-ins** - Special arguments that are always made
  ...
  and their meanings is below.](#list-of-built-ins)

<a id="list-of-built-ins"></a>
...
> **Note:** The **\*** at the center vertex of the 'M' represents a checkpoint
...
see [this Django bug report](https://code.djangoproject.com/ticket/18577)
which led to corrected Django documentation.
...
makes [WSGI slightly choreful](https://docs.djangoproject.com/en/dev/howto/deployment/wsgi/),
which is a shame, because [WSGI](http://wsgi.readthedocs.org/en/latest/what.html) has
...
- [Kurt Rose](https://github.com/doublereedkurt) - Design review and implementation
- [Justin van Winkle](https://twitter.com/jvantastic) - Inspiration
- [Pocoo](https://pocoo.org) and the [Werkzeug](https://werkzeug.pocoo.org) team - For a very great WSGI toolkit
...
- [Tarball of Clastic 0.3.0](https://pypi.python.org/packages/source/c/clastic/clastic-0.3.0.tar.gz#md5=3672ea706921353458fce7714140bde2)
